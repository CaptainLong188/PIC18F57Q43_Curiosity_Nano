...
void LCD_pulse_clock(){
  ...
  LATCbits.LATC1 = 1;
  _delay((unsigned long)((60)*(64000000UL/4000000.0)));
  LATCbits.LATC1 = 0;
}
...
void LCD_write_command(char command){
    ...
    LATFbits.LATF7 = (command & 0b10000000) >> 7;
    LATFbits.LATF6 = (command & 0b01000000) >> 6;
    LATFbits.LATF5 = (command & 0b00100000) >> 5;
    LATFbits.LATF4 = (command & 0b00010000) >> 4;


    LCD_pulse_clock();


    LATFbits.LATF7 = (command & 0b00001000) >> 3;
    LATFbits.LATF6 = (command & 0b00000100) >> 2;
    LATFbits.LATF5 = (command & 0b00000010) >> 1;
    LATFbits.LATF4 = (command & 0b00000001) ;
...
void LCD_write_data(char data){
    ...
    LATFbits.LATF7 = (data & 0b10000000) >> 7;
    LATFbits.LATF6 = (data & 0b01000000) >> 6;
    LATFbits.LATF5 = (data & 0b00100000) >> 5;
    LATFbits.LATF4 = (data & 0b00010000) >> 4;


    LCD_pulse_clock();


    LATFbits.LATF7 = (data & 0b00001000) >> 3;
    LATFbits.LATF6 = (data & 0b00000100) >> 2;
    LATFbits.LATF5 = (data & 0b00000010) >> 1;
    LATFbits.LATF4 = (data & 0b00000001) ;
...
void LCD_Init(){
    ...
    TRISFbits.TRISF6 = 0; LATFbits.LATF6 = 0;
    TRISFbits.TRISF7 = 0; LATFbits.LATF7 = 0;
    ...
    LATFbits.LATF7 = 0; LATFbits.LATF6 = 0; LATFbits.LATF5 = 1; LATFbits.LATF4 = 1;


    LCD_pulse_clock();


    _delay((unsigned long)((6)*(64000000UL/4000.0)));


    LCD_pulse_clock();


    _delay((unsigned long)((150)*(64000000UL/4000000.0)));


    LCD_pulse_clock();


    LATFbits.LATF7 = 0; LATFbits.LATF6 = 0; LATFbits.LATF5 = 1; LATFbits.LATF4 = 0;
...
void LCD_Configure_Display(uint8_t state){
...
void LCD_Clear(){
    ...
    _delay((unsigned long)(((2300-60))*(64000000UL/4000000.0)));
